...
```{r compound-corrgram-BKT-plot, fig.cap="Spline correlogram of log brook trout density by lide stage and subregion."}
...
```{r YOY-ICC-semivariogram-plot, fig.cap="Semivariogram of YOY ICC values. Shading indicates 95% confidence intervals. Dotted lines represent average correlation."}
